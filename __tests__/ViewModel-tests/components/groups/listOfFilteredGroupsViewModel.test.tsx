...
describe("ListOfFilteredGroups ViewModel", () => {
  ...
  it("handles joining a group", async () => {
    ...
    expect(mockFirestoreCtrl.addGroupToUser).toHaveBeenCalledWith("tester-uid", "Group Test 1");
    expect(mockFirestoreCtrl.addMemberToGroup).toHaveBeenCalledWith("1", "tester-uid");
