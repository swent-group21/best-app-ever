...
describe("Group Screen renders challenges", () => {
  ...
  it ("renders the group screen", () => {
    const { getByTestId } = render(<GroupScreen user={{}} navigation={{}} route={{}} firestoreCtrl={mockFirestoreCtrl} />);
...
describe("Group Screen renders challenges", () => {
  ...
  it("renders correct message when no challenge to display", () => {
    const { getByTestId } = render(<GroupScreen user={{}} navigation={{}} route={{}} firestoreCtrl={{}} />);
