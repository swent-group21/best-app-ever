...
describe('ListOfFilteredUsers', () => {
  ...
  it('renders filtered users with correct statuses', async () => {
    ...
    await waitFor(() => expect(mockFirestoreCtrl.isFriend).toHaveBeenCalledTimes(2));
  ...
  it('handles adding a friend', async () => {
    ...
    await waitFor(() => expect(mockFirestoreCtrl.addFriend).toHaveBeenCalledWith('user-uid', '2'));
  });
