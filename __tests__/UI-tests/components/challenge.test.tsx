...
describe('Challenge Component', () => {
  ...
  it('fetches and displays user info when open', async () => {
    ...
    await waitFor(() => {
      expect(mockFirestoreCtrl.getUser).toHaveBeenCalledWith(challengeDBMock.uid);
  ...
  it('navigates to MaximizeScreen when expand icon is pressed', () => {
    ...
    // Check navigation
    expect(mockNavigation.navigate).toHaveBeenCalledWith("Maximize", {"challenge": {"date": "2023-10-10", "image_id": "https://example.com/image.jpg", "uid": "123"}, "user": undefined});
  });
});
