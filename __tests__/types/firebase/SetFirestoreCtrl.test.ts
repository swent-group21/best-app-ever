...
describe('SetFirestoreCtrl', () => {
  describe('createUser', () => {
    ...
    it('should handle errors when writing user document', async () => {
      ...
      jest.spyOn(Firebase, "setDoc").mockImplementationOnce(
        (): Promise<any> =>
      ...
      expect(console.error).toHaveBeenCalledWith('Error writing user document: ', error);
    });
  });
  ...
  describe('uploadImage', () => {
    ...
    it('should throw an error when no image URI is provided', async () => {
      await expect(uploadImage('')).rejects.toThrow('No image URI provided.');
    });
...
;
      ...
      expect(console.error).toHaveBeenCalledWith('Error uploading image: ', error);
    });
  });
  ...
  describe('setProfilePicture', () => {
    ...
    it('should handle errors when setting profile picture', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith("Error setting profile picture: ", error);
    });
  });
  ...
  describe('newChallenge', () => {
    ...
    it('should handle errors when writing challenge to Firestore', async () => {
      ...
      jest.spyOn(Firebase, "addDoc").mockImplementationOnce(
      ...
      expect(console.error).toHaveBeenCalledWith('Error writing challenge document to Firestore: ', error);
    });
    ...
    it('should handle errors when writing challenge locally', async () => {
      ...
      jest.spyOn(LocalStorageCtrl, "storeChallengeLocally").mockImplementationOnce(
        (): Promise<any> => Promise.reject(error)
      )
  ...
  describe('newGroup', () => {
    ...
    it('should handle errors when writing group to Firestore', async () => {
      ...
      await newGroup(groupData);
      expect(console.error).toHaveBeenCalledWith('Error writing group document to Firestore: ', error);
    });
    ...
    it('should handle errors when writing group to Local Cache', async () => {
      ...
      jest.spyOn(LocalStorageCtrl, "storeGroupLocally").mockImplementationOnce(
        (): Promise<any> =>
          Promise.reject(error)
      )
  ...
  describe('updateGroup', () => {
    ...
    it('should handle errors when updating group', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error updating group: ', error);
    });
  });
  ...
  describe('appendComment', () => {
    ...
    it('should handle errors when writing comment to Firestore', async () => {
      ...
      await appendComment(commentData)
      expect(console.error).toHaveBeenCalledWith('Error writing comment document to Firestore:', error);
    });
  ...
  describe('updateLikesOf', () => {
    ...
    it('should handle errors when updating likes', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error updating likes: ', error);
    });
  });
  ...
  describe('addFriend', () => {
    ...
    it('should handle errors when adding friend', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error adding friend: ', error);
    });
  });
  ...
  describe('acceptFriend', () => {
    ...
    it('should handle errors when accepting friend', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error accepting friend: ', error);
    });
  });
  ...
  describe('removeFriendRequest', () => {
    ...
    it('should handle errors when removing friend request', async () => {
      ...
      await expect(removeFriendRequest('userId', 'friendId')).rejects.toThrow(error);
      expect(console.error).toHaveBeenCalledWith('Error unadding friend: ', error);
    });
  });
