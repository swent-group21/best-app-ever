...
export function TopBar({ leftIcon, leftAction, rightIcon, rightAction, title, colorType="white" }: TopbarProps) {
    ...
    return (
        <View style={styles.container}>
            ...
            {title && <ThemedText style={styles.title} colorType={colorType}>{title}</ThemedText>}
